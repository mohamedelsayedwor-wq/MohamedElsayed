...
const ecommerceImage =
    document.getElementById("ClothesstoreGalleryImage");

const ecommerceThumbnails =
    document.getElementById("ClothesstoreThumbnails");

const ecommercePrev =
    document.getElementById("ClothesstorePrev");

const ecommerceNext =
    document.getElementById("ClothesstoreNext");

const ecommerceCurrent =
    document.getElementById("ClothesstoreCurrent");

const ecommerceTotal =
    document.getElementById("ClothesstoreTotal");
